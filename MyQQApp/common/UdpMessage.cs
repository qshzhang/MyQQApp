...
namespace MyQQApp.common
{
    ...
    public class UdpMessage
    {
        ...
        public UdpMessage(NetAddr myNetAddr)
        {
            ...
            RevSocket.Bind(new IPEndPoint(IPAddress.Parse(myNetAddr.IP), myNetAddr.UdpPort));
        ...
        {
            EndPoint point = new IPEndPoint(IPAddress.Parse(friendNetAddr.IP), friendNetAddr.UdpPort);
        ...
        private void ReciveMsg()
        {
            ...
            while (true)
            {
                ...
                friendAddr.IP = ((IPEndPoint)remotePoint).Address.ToString();
