...
namespace MyQQApp.Forms
{
    public partial class FrmCaptureScreen : Form
    {
        ...
        private void FrmCaptureScreen_DoubleClick(object sender, EventArgs e)
        {
            if (((MouseEventArgs)e).Button == MouseButtons.Left
                && Rect.Contains(((MouseEventArgs)e).X, ((MouseEventArgs)e).Y))
            {
        ...
        private void FrmCaptureScreen_MouseMove(object sender, MouseEventArgs e)
        {
            if (RectReady == false)
            {
                if (isDowned == true)
