...
namespace MyQQApp.ChatListControl
{
    ...
    public class ChatListSubItem : IComparable
    {
        ...
        int IComparable.CompareTo(object obj) {
            ...
            int result = (this.status).CompareTo(subItem.status);
            if (result == 0) return this.id.CompareTo(subItem.id);
            return result;
        }
        ...
        public ChatListSubItem(string id, string nicname, string displayname, string personalmsg, UserStatus status, Image head) {
            this.id = id;
            this.nicName = nicname;
            this.displayName = displayname;
            this.personalMsg = personalmsg;
        ...
        public ChatListSubItem(string id, string nicname, string displayname, string personalmsg, UserStatus status, Bitmap head)
        {
            this.id = id;
            this.nicName = nicname;
            this.displayName = displayname;
